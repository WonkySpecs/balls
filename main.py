...
while game_state.running:
	modes.set_from_handled_inputs(game_state.handle_inputs(pygame.event.get()))

	if not game_state.paused:
		new_ball_handler.update(game_state.click_spawns)
		...
		painter.paint(screen, balls, grav_balls, modes.ball_colour)
